...
public final class DTW {
    ...
    private Movement bicepsReference;
    private Movement hammerReference;
    private Movement tricepsReference;
    private Movement reverseReference;

    public Movement getBicepsReference() {
        return bicepsReference;
    }

    public Movement getHammerReference() {
        return hammerReference;
    }

    public Movement getTricepsReference() {
        return tricepsReference;
    }

    public Movement getReverseReference() {
    ...
    public DTW(Movement bicepsReference, Movement hammerReference, Movement tricepsReference, Movement reverseReference) {
        this.bicepsReference = bicepsReference;
        this.hammerReference = hammerReference;
        this.tricepsReference = tricepsReference;
